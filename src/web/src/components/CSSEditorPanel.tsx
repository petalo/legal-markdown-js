...
export function CSSEditorPanel({ css, onChange, onReset, headerLeft }: CSSEditorPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-900">
      <div className="flex items-center justify-between px-3 py-1.5 border-b border-slate-700 shrink-0">
        ...
        <div className="flex items-center gap-1 shrink-0">
          <Tooltip>
            ...
            <TooltipContent>Upload .css file</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="icon"
                className="h-6 w-6 cursor-pointer"
                aria-label="Reset CSS to preset"
                onClick={onReset}
              >
      ...
      <textarea
        ...
        placeholder="/* Custom CSS for the preview... */"
      />
    </div>
  );
}
